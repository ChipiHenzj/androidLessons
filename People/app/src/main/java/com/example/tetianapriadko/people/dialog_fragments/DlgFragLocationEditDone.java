...
import com.example.tetianapriadko.people.MapsActivityEditDone;

public class DlgFragLocationEditDone extends DlgFragAbstractOkCancel {

    private MapsActivityEditDone targetActivity;
    ...
    public void setTargetActivity(MapsActivityEditDone targetActivity, int requestCode){
